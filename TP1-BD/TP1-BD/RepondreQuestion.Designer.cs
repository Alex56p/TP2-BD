namespace TP1_BD
{
    partial class RepondreQuestion
    {
        ...
        private void InitializeComponent()
        {
         ...
         this.TB_Reponse4.Click += new System.EventHandler(this.TB_Reponse4_Click);
         // 
         // TB_Reponse3
         // 
         ...
         this.TB_Reponse3.Click += new System.EventHandler(this.TB_Reponse3_Click);
         // 
         // TB_Reponse1
         // 
         ...
         this.TB_Reponse2.Click += new System.EventHandler(this.TB_Reponse2_Click);
         // 
         // groupBox1
         // 
